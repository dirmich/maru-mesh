...
- **Client install URL**: client 설치 스크립트는 public repo raw URL(`https://raw.githubusercontent.com/dirmich/maru-mesh/main/install.sh`, `https://raw.githubusercontent.com/dirmich/maru-mesh/main/install.ps1`)을 공식 진입점으로 사용합니다.
